...
<?php
    ...
    if(isset($_POST['kaydet'])) {
        $gelir = new Gelir(1, $_POST['ad'], $_POST['miktar'], $_POST['aciklama'], $_POST['tarih']);
        insertGelir($gelir);
...
<div class="container-fluid mt-5">
    <a href="gelir.php" class="btn btn-sm" style="background-color: black; color: white;"><i class="lni lni-arrow-left"></i></a>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card text-center">
                <h4 class="mt-3">Gelir Ekle</h4>
                <div class="card-body">
